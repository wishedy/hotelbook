...
$(document).ready(function(){
    ...
    var roomDetail = {
        ...
        path:{
            ...
            imgList: "//www.jikelearn.cn/web-ssm/imageDisRest/showImage"
        },
          ...
          var t = this;
            $.ajax({
                ...
                success: function (data, status) {
                    ...
                    $(".Gambier-scrollTop").scroll({link:"//www.jikelearn.cn/pages/scene/book/book_info.html?roomId="+t.queryName("roomId"),text:"现在预订"});
...
*/
        ...
        swiperInit:function(){
            ...
            $(".ev-book-now").attr({"href":"//www.jikelearn.cn/pages/scene/book/book_info.html?roomId="+t.queryName("roomId")});
            return t;
        }
    };
    roomDetail.init();
